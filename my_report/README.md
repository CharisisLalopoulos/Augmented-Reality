...
**Τέλος ολοκλήρωσα τις αισθητικές αλλαγές στην αρχική σελίδα, προσθέτοντας 3 μικρές περιγραφές στην κάθε θεματική ενότητα: Marker Based/ Location Based/ Syros Location Based** ![](Report_images/.png)
